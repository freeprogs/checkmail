...
** TASK Сделать Makefile
   ...
   - [ ] Сделать автоматическое версионирование программы (через m4).
     Программа запускается и локально для отладки, поэтому нужно
     предусмотреть формирование отладочной локальной версии.
   - [ ] Сделать возможность установки программы.
   - [ ] Сделать возможность удаления программы.
   - [ ] Сделать возможность очистки проекта от лишних файлов.

** TASK Сделать скрипт для формирования релиза
   :PROPERTIES:
   :issue_id: 3
   :issue_type: task
   :END:
...
** TASK [#A] Приготовить репозиторий к публикации
   ...
   - [ ] Поискать пароли в истории
   - [ ] Поставить правильно версии
   - [ ] Поставить правильно ветки
   - [ ] Настроить автора и почту
